<template>
  <nav class="bg-gray-50 h-12 shadow-sm">
    ...
    <div v-if="props.type === 'tagManage'" class="w-1000 m-auto flex">
      <router-link to="/tag/follow" class="tag-manage-item" active-class="text-blue-500">已关注频道</router-link>
      <router-link to="/tag/all" class="tag-manage-item" active-class="text-blue-500">全部频道</router-link>
    </div>
...
<style scoped>
.tag-item {
  @apply mx-2 text-sm h-12 text-center leading-12 cursor-pointer text-gray-500  hover:text-blue-500;
}
...
.topic-item {
  @apply mx-4 h-12 text-center leading-12 cursor-pointer text-gray-600  hover:text-blue-500;
}
</style>